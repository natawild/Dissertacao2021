...
# Load data
trend_data <- read_csv("~/Documents/GitHub/Tese/ShinyAplication/GoogleTrendIndex/data/trend_data.csv")
trend_description <- read_csv("~/Documents/GitHub/Tese/ShinyAplication/GoogleTrendIndex/data/trend_description.csv")
